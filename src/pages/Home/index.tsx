...
const Home = () => {
  return (
    ...
    >
      <Link
        to="/login"
        className="flex shadow-sm break-inside bg-black rounded-3xl px-8 py-4 mb-4 w-2/4 dark:bg-slate-800 dark:text-white"
      >
        <div className="flex items-center justify-between flex-1">
          <span className="text-lg font-medium text-white">Empecemos</span>
          <svg
            width="17"
            height="17"
            viewBox="0 0 17 17"

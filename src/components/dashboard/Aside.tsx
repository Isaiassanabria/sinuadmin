...
const Aside = () => {
  const { setAuth, setSearch } = useAuth();
  const logout = () => {
    setAuth(USER_INITIAL_STATE);
    setSearch("");
        ...
        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          <div className="flex-1 px-3 bg-white divide-y space-y-1">
            ...
            <div className="space-y-2 pt-2">
              <button
                className="text-base text-gray-900 font-normal pr-[68%] rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                onClick={logout}
              >
                <svg
                  className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                ...
                <span className="ml-3 flex-1 whitespace-nowrap">Salir</span>
              </button>
              <a
              ...
              >
                ...
                <span className="ml-3">Documentación</span>
              </a>
            </div>
          </div>
        </div>
